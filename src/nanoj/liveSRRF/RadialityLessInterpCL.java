...
public class RadialityLessInterpCL {
    ...
    public RadialityLessInterpCL(int width, int height, int magnification, double ringRadius, double radialitySensitivity) {
        ...
        // create the program
        try {
            program = context.createProgram(RadialityLessInterpCL.class.getResourceAsStream("/RadialityLessInterp.cl")).build();
        } catch (IOException e) {
            e.printStackTrace();
        }
