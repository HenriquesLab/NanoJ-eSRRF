...
eSRRF (enhanced Super-Resolution Radial Fluctuations) is an extension of the SRRF method developed by the Henriques lab (**[Gustafsson _et al._ (2018)](http://www.nature.com/articles/ncomms12471)**). For more details check out our **[preprint](https://doi.org/10.1101/2022.04.07.487490)** on bioRXiv. 
...
* Adaptive reconstruction schemes allowing to explore the compromise between **fidelity** and **resolution**. This is enabled by an integration of our SQUIRREL approach (**[Culley _et al._ (2018)](https://doi.org/10.1038/nmeth.4605)**);
